...
import Vista.Consul_Entrada;
import Vista.Consul_Tipo_Vehiculo;
import java.awt.event.ActionEvent;
import java.awt.event.ActionListener;

public class Consul_Entrada_Control implements ActionListener {

    Consul_Entrada cd;
    
    
    public Consul_Entrada_Control(Consul_Entrada obj) {
       cd = obj;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(!error){ // si no hay error de conexion a la bd, entonces ...
            ...
            System.out.println(cd.mt.getRowCount());
            String registros[][] = con.consultaMatriz("Clientes y vehiculos", "entrada = '" + cd.jttipo.getText() + "'");
            if (registros != null) {
