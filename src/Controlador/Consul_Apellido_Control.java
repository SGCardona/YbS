...
import Vista.Consul_Apellido;
import java.awt.event.ActionEvent;
import java.awt.event.ActionListener;

public class Consul_Apellido_Control implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(!error){ // si no hay error de conexion a la bd, entonces ...
            ...
            System.out.println(cd.mt.getRowCount());
            String registros[][] = con.consultaMatriz("Clientes y vehiculos", "apellido = '" + cd.jttipo.getText() + "'");
            if (registros != null) {
