...
import Vista.Consul_Modelo;
import java.awt.event.ActionEvent;
import java.awt.event.ActionListener;

public class Consul_Modelo_Control implements ActionListener {

    Consul_Modelo cd;
    
    
    public Consul_Modelo_Control(Consul_Modelo obj) {
       cd = obj;
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource().equals(cd.jtmodelo)){
