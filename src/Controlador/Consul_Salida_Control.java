...
import Vista.Consul_Salida;
import java.awt.event.ActionEvent;
import java.awt.event.ActionListener;

public class Consul_Salida_Control implements ActionListener {

    Consul_Salida cd;
    
    
    public Consul_Salida_Control(Consul_Salida obj) {
       cd = obj;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(!error){ // si no hay error de conexion a la bd, entonces ...
            ...
            System.out.println(cd.mt.getRowCount());
            String registros[][] = con.consultaMatriz("Clientes y vehiculos", "salida = '" + cd.jttipo.getText() + "'");
            if (registros != null) {
