...
public class Consul_Cliente_X_ID_Control implements ActionListener {

    Consul_Cliente_X_ID cd;
    
    
    public Consul_Cliente_X_ID_Control(Consul_Cliente_X_ID obj) {
       cd = obj; 
    }
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource().equals(cd.jtCedula)){
