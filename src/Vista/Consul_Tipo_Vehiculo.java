...
public class Consul_Tipo_Vehiculo extends JPanel{ //Vista de consultar por tipo vehiculo
    ...
    public Consul_Tipo_Vehiculo(SubMenuConsultas_Vista sub) {
        this.sub = sub;
    ...
    public void GUI(){
     ...
     Consul_Tipo_Vehiculo_Control ctrl = new Consul_Tipo_Vehiculo_Control(this);
     tablaC(ctrl);
     
    }
    
    public void tablaC(Consul_Tipo_Vehiculo_Control obj){
        
        jlTituloJTable = new JLabel("  Consulta por Tipo Vehiculo");        
