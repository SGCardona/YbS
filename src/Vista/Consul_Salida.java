...
import Controlador.Consul_Salida_Control;
...
public class Consul_Salida extends JPanel{ //Vista de consultar por hora salida vehiculo
    ...
    public Consul_Salida(SubMenuConsultas_Vista sub) {
        this.sub = sub;
    ...
    public void GUI(){
     ...
     Consul_Salida_Control ctrl = new Consul_Salida_Control(this);
     tablaC(ctrl);
     
    }
    
    public void tablaC(Consul_Salida_Control obj){
        
        jlTituloJTable = new JLabel("  Consulta por Hora  Salida Vehiculo");        
