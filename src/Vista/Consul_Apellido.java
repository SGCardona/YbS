...
import Controlador.Consul_Apellido_Control;
...
public class Consul_Apellido extends JPanel{ //Vista de consultar por apellido cliente
    ...
    public Consul_Apellido(SubMenuConsultas_Vista sub) {
        this.sub = sub;
    ...
    public void GUI(){
     ...
     Consul_Apellido_Control ctrl = new Consul_Apellido_Control(this);
     tablaC(ctrl);
     
    }
    
    public void tablaC(Consul_Apellido_Control obj){
        
        jlTituloJTable = new JLabel("  Consulta por Apellido Cliente");        
